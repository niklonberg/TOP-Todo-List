...
const TodoUIManager = (() => {
  ...
  const showSelectedGroup = (event) => {
    ...
    if (listGroup !== previousListGroup) {
      ...
      _ProjectManager_js__WEBPACK_IMPORTED_MODULE_0__["default"].setSelectedProject(projectID); //rename
