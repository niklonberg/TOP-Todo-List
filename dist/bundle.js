...
`, "",{"version":3,"sources":["webpack://./src/css-components/side-bar.css"],"names":[],"mappings":"AAAA;EACE;IACE,yCAAyC;IACzC,+CAA+C;IAC/C,sBAAsB;IACtB,+BAA+B;IAC/B,4BAA4B;EAC9B;;EAEA;IACE,0CAA0C;IAC1C,qBAAqB;IACrB,gBAAgB;EAClB;;EAEA;IACE,gBAAgB;IAChB,UAAU;EACZ;;EAEA;IACE,aAAa;IACb,mBAAmB;IACnB,kBAAkB;EACpB;AACF","sourcesContent":["@layer component {\n  #side-bar {\n    background-color: var(--primary-contrast);\n    box-shadow: 5px 0px 10px 0px rgba(0, 0, 0, 0.2);\n    /* max-width: 300px; */\n    /* overflow-wrap: break-word; */\n    padding-inline: var(--m-gap);\n  }\n\n  #side-bar h2 {\n    border-bottom: 2px solid var(--text-color);\n    letter-spacing: 1.5px;\n    margin-bottom: 0;\n  }\n\n  #side-bar ul {\n    list-style: none;\n    padding: 0;\n  }\n\n  #side-bar ul li {\n    display: flex;\n    align-items: center;\n    gap: var(--sm-gap);\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
