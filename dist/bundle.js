...
`, "",{"version":3,"sources":["webpack://./src/css-components/list-item.css"],"names":[],"mappings":"AAAA;EACE;IACE,aAAa;IACb,mBAAmB;IACnB,kBAAkB;IAClB,eAAe;EACjB;;EAEA;IACE,6BAA6B;EAC/B;;EAEA;IACE,OAAO;EACT;;EAEA;IACE,WAAW;IACX,YAAY;IACZ,SAAS;EACX;;EAEA;IACE,yDAA+C;IAC/C,qBAAqB;IACrB,4BAA4B;IAC5B,kBAAkB;EACpB;;EAEA;IACE,WAAW;IACX,YAAY;IACZ,mDAA2C;IAC3C,wBAAwB;IACxB,YAAY;EACd;;EAEA;IACE,yDAAyC;IACzC,kCAAkC;EACpC;;EAEA;IACE;;MAEE,mBAAmB;IACrB;IACA;MACE,yBAAyB;IAC3B;IACA;MACE,qBAAqB;MACrB,4BAA4B;IAC9B;IACA;MACE,wBAAwB;IAC1B;EACF;AACF","sourcesContent":["@layer component {\n  .list-item {\n    display: flex;\n    align-items: center;\n    gap: var(--sm-gap);\n    cursor: pointer;\n  }\n\n  .list-item.todo-complete {\n    text-decoration: line-through;\n  }\n\n  .list-details {\n    flex: 1;\n  }\n\n  .toggle-complete-btn {\n    width: 20px;\n    height: 20px;\n    order: -1;\n  }\n\n  .toggle-complete-btn.checked {\n    background-image: url(../images/check-mark.png);\n    background-size: 100%;\n    background-repeat: no-repeat;\n    border-radius: 50%;\n  }\n\n  .toggle-important-btn {\n    width: 20px;\n    height: 20px;\n    background: url(../images/star-outline.png);\n    background-size: contain;\n    border: none;\n  }\n\n  .toggle-important-btn.checked {\n    background-image: url(../images/star.png);\n    animation: scaleImpBtn 1s ease-out;\n  }\n\n  @keyframes scaleImpBtn {\n    0%,\n    100% {\n      transform: scale(1);\n    }\n    25% {\n      transform: rotate(-10deg);\n    }\n    50% {\n      transform: scale(1.5);\n      transform: translateY(-10px);\n    }\n    75% {\n      transform: rotate(10deg);\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _createElement_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./createElement.js */ "./src/modules/createElement.js");
...
const TodoUIManager = (() => {
  ...
  const showSelectedGroup = (event) => {
    ...
    if (listGroupSelection !== previousListGroupSelection) {
      ...
      if (projectID) _ProjectManager_js__WEBPACK_IMPORTED_MODULE_1__["default"].setSelectedProject(+projectID);
  ...
  const renderSelectedGroup = (listGroupSelection) => {
    ...
    if (selectedGroupTodos.length !== 0) {
      ...
      const p = (0,_createElement_js__WEBPACK_IMPORTED_MODULE_4__["default"])("p");
