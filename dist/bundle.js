...
const TodoUIManager = (() => {
  ...
  allTasks.addEventListener("click", () => {
    console.log(_ProjectManager_js__WEBPACK_IMPORTED_MODULE_0__["default"].getFilteredTasks());
  });
  /* test */
