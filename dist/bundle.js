...
const FormManager = (() => {
  ...
  const handleFormSubmit = (event, form, isNewProject) => {
    ...
    let object;
    isNewProject
      ? (object = _ProjectManager_js__WEBPACK_IMPORTED_MODULE_5__["default"].addProject(templateObj))
      : (object = _ProjectManager_js__WEBPACK_IMPORTED_MODULE_5__["default"].addTodoToSelectedProject(templateObj));
