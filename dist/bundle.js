...
`, "",{"version":3,"sources":["webpack://./src/css-components/list-item.css"],"names":[],"mappings":"AAAA;EACE;IACE,aAAa;IACb,mBAAmB;IACnB,kBAAkB;IAClB,eAAe;EACjB;AACF","sourcesContent":["@layer component {\n  .list-item {\n    display: flex;\n    align-items: center;\n    gap: var(--sm-gap);\n    cursor: pointer;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
`, "",{"version":3,"sources":["webpack://./src/css-components/side-bar.css"],"names":[],"mappings":"AAAA;EACE;IACE,yCAAyC;IACzC,+CAA+C;IAC/C,yBAAyB;IACzB,gBAAgB;IAChB,4BAA4B;EAC9B;;EAEA;IACE,gBAAgB;IAChB,UAAU;EACZ;;EAEA;IACE,6BAA6B;EAC/B;;EAEA;IACE,gCAAgC;EAClC;;EAEA;IACE,0CAA0C;IAC1C,qBAAqB;EACvB;EACA,sCAAsC;EACtC;;;KAGG;AACL","sourcesContent":["@layer component {\n  #side-bar {\n    background-color: var(--primary-contrast);\n    box-shadow: 5px 0px 10px 0px rgba(0, 0, 0, 0.2);\n    overflow-wrap: break-word;\n    max-width: 300px;\n    padding-inline: var(--m-gap);\n  }\n\n  #side-bar ul {\n    list-style: none;\n    padding: 0;\n  }\n\n  #side-bar .list-item {\n    padding-inline: var(--sm-gap);\n  }\n\n  #side-bar .list-item:hover {\n    background-color: var(--primary);\n  }\n\n  #side-bar h2 {\n    border-bottom: 2px solid var(--text-color);\n    letter-spacing: 1.5px;\n  }\n  /* ensure long words break correctly */\n  /* #side-bar h3 {\n    min-width: 0;\n    flex: 1;\n  } */\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
