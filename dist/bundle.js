...
const TodoUIManager = (() => {
  ...
  const editSelectedItem = (event) => {
    ...
    if (isEditAction) {
      _FormManager_js__WEBPACK_IMPORTED_MODULE_0__["default"].createForm(event, object, objectID, parentLi);
    }
  };
