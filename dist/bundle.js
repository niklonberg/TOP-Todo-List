...
`, "",{"version":3,"sources":["webpack://./src/css-components/base.css"],"names":[],"mappings":"AAAA;EACE;IACE,6BAA6B;IAC7B,sCAAsC;IACtC,8BAA8B;IAC9B,gBAAgB;IAChB,6BAA6B;;IAE7B,cAAc;IACd,aAAa;IACb,aAAa;;IAEb,YAAY;IACZ,YAAY;EACd;;EAEA;;;IAGE,sBAAsB;EACxB;;EAEA;IACE,kCAAkC;IAClC,gCAAgC;IAChC,wBAAwB;IACxB,SAAS;EACX;;EAEA;;;;IAIE,aAAa;IACb,eAAe;EACjB;AACF","sourcesContent":["@layer base {\n  :root {\n    --primary: rgb(239, 239, 239);\n    --primary-contrast: rgb(255, 255, 255);\n    --secondary: rgb(41, 186, 101);\n    --tertiary: blue;\n    --text-color: rgb(52, 52, 52);\n\n    --sm-gap: 10px;\n    --m-gap: 20px;\n    --l-gap: 30px;\n\n    --sm-br: 5px;\n    --m-br: 10px;\n  }\n\n  *,\n  *::before,\n  *::after {\n    box-sizing: border-box;\n  }\n\n  body {\n    font-family: system-ui, sans-serif;\n    background-color: var(--primary);\n    color: var(--text-color);\n    margin: 0;\n  }\n\n  input,\n  textarea,\n  button,\n  select {\n    font: inherit;\n    font-size: 100%;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
`, "",{"version":3,"sources":["webpack://./src/css-components/list-item.css"],"names":[],"mappings":"AAAA;EACE;IACE,aAAa;IACb,mBAAmB;IACnB,kBAAkB;IAClB,eAAe;EACjB;;EAEA;IACE,6BAA6B;EAC/B;;EAEA;IACE,OAAO;EACT;;EAEA;IACE,eAAe;IACf,WAAW;IACX,YAAY;IACZ,SAAS;EACX;;EAEA;IACE,yDAA+C;IAC/C,qBAAqB;IACrB,4BAA4B;IAC5B,kBAAkB;EACpB;AACF","sourcesContent":["@layer component {\n  .list-item {\n    display: flex;\n    align-items: center;\n    gap: var(--sm-gap);\n    cursor: pointer;\n  }\n\n  .list-item.todo-complete {\n    text-decoration: line-through;\n  }\n\n  .list-details {\n    flex: 1;\n  }\n\n  .toggle-complete-btn {\n    cursor: pointer;\n    width: 20px;\n    height: 20px;\n    order: -1;\n  }\n\n  .toggle-complete-btn.checked {\n    background-image: url(../images/check-mark.png);\n    background-size: 100%;\n    background-repeat: no-repeat;\n    border-radius: 50%;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
