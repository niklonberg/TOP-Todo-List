...
`, "",{"version":3,"sources":["webpack://./src/css-components/base.css"],"names":[],"mappings":"AAAA;EACE;IACE,6BAA6B;IAC7B,sCAAsC;IACtC,kBAAkB;IAClB,gBAAgB;IAChB,6BAA6B;;IAE7B,cAAc;IACd,aAAa;IACb,aAAa;;IAEb,YAAY;IACZ,YAAY;EACd;;EAEA;;;IAGE,sBAAsB;EACxB;;EAEA;IACE,kCAAkC;IAClC,gCAAgC;IAChC,wBAAwB;IACxB,SAAS;EACX;;EAEA;;;;IAIE,aAAa;IACb,eAAe;EACjB;AACF","sourcesContent":["@layer base {\n  :root {\n    --primary: rgb(239, 239, 239);\n    --primary-contrast: rgb(255, 255, 255);\n    --secondary: green;\n    --tertiary: blue;\n    --text-color: rgb(52, 52, 52);\n\n    --sm-gap: 10px;\n    --m-gap: 20px;\n    --l-gap: 30px;\n\n    --sm-br: 5px;\n    --m-br: 10px;\n  }\n\n  *,\n  *::before,\n  *::after {\n    box-sizing: border-box;\n  }\n\n  body {\n    font-family: system-ui, sans-serif;\n    background-color: var(--primary);\n    color: var(--text-color);\n    margin: 0;\n  }\n\n  input,\n  textarea,\n  button,\n  select {\n    font: inherit;\n    font-size: 100%;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
`, "",{"version":3,"sources":["webpack://./src/css-components/side-bar.css"],"names":[],"mappings":"AAAA;EACE;IACE,yCAAyC;IACzC,+CAA+C;IAC/C,yBAAyB;IACzB,gBAAgB;IAChB,4BAA4B;EAC9B;;EAEA;IACE,gBAAgB;IAChB,UAAU;EACZ;;EAEA;IACE,0CAA0C;IAC1C,qBAAqB;EACvB;;EAEA;IACE,YAAY,EAAE,sCAAsC;IACpD,OAAO;EACT;AACF","sourcesContent":["@layer component {\n  #side-bar {\n    background-color: var(--primary-contrast);\n    box-shadow: 5px 0px 10px 0px rgba(0, 0, 0, 0.2);\n    overflow-wrap: break-word;\n    max-width: 300px;\n    padding-inline: var(--m-gap);\n  }\n\n  #side-bar ul {\n    list-style: none;\n    padding: 0;\n  }\n\n  #side-bar h2 {\n    border-bottom: 2px solid var(--text-color);\n    letter-spacing: 1.5px;\n  }\n\n  #side-bar h3 {\n    min-width: 0; /* ensure long words break correctly */\n    flex: 1;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
