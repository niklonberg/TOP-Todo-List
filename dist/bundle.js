...
function createListItemFromObject(object) {
  ...
  for (const [key, value] of Object.entries(object)) {
    ...
    if (key === "completionDate") {
      ...
      console.log(value);
      const time = (0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__["default"])("time");
      time.setAttribute("datetime", value);
      time.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(value, "MMMM do, ccc - yyyy");
      li.appendChild(time);
    }
  }
