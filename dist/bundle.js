...
function createObjectFromForm(formInputs) {
  return formInputs.reduce((object, item) => {
    ...
    if (item.id === "completionDate") {
      ...
      if (item.value) {
        const todoDueDate = (0,date_fns_parse__WEBPACK_IMPORTED_MODULE_2__["default"])(item.value, "yyyy-MM-dd", new Date());
