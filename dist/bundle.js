...
`, "",{"version":3,"sources":["webpack://./src/css-components/list-item.css"],"names":[],"mappings":"AAAA;EACE;IACE,aAAa;IACb,mBAAmB;IACnB,kBAAkB;IAClB,eAAe;EACjB;;EAEA;IACE,OAAO;EACT;;EAEA;IACE,eAAe;IACf,WAAW;IACX,YAAY;IACZ,SAAS;EACX;;EAEA;IACE,yDAA+C;IAC/C,qBAAqB;IACrB,4BAA4B;IAC5B,kBAAkB;EACpB;AACF","sourcesContent":["@layer component {\n  .list-item {\n    display: flex;\n    align-items: center;\n    gap: var(--sm-gap);\n    cursor: pointer;\n  }\n\n  .list-details {\n    flex: 1;\n  }\n\n  .toggle-complete-btn {\n    cursor: pointer;\n    width: 20px;\n    height: 20px;\n    order: -1;\n  }\n\n  .toggle-complete-btn.checked {\n    background-image: url(../images/check-mark.png);\n    background-size: 100%;\n    background-repeat: no-repeat;\n    border-radius: 50%;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
