...
const TodoUIManager = (() => {
  ...
  const showSelectedGroup = (event) => {
    ...
    if (listGroupSelection !== previousListGroupSelection) {
      ...
      if (projectID !== null) _ProjectManager_js__WEBPACK_IMPORTED_MODULE_0__["default"].setSelectedProject(projectID);
